...
## Result:
The Matrix transposition on shared memory with grid (1,1) block (16,16) is demonstrated successfully.](https://github.com/RamprabhuRajavelu/-PCA-Implement-Matrix-Multiplication-using-CUDA-C.-Find-the-elapsed-time./blob/main/README.md)https://github.com/RamprabhuRajavelu/-PCA-Implement-Matrix-Multiplication-using-CUDA-C.-Find-the-elapsed-time./blob/main/README.md
